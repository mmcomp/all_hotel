...
?>
	...
	<table   dir='rtl' width="100%" >
		<tr>
			<td colspan='10' align='center'><h1>فرم اطلاعات</h1></td>
		</tr>
		<tr>
	
		</tr>
			<td><strong>تاریخ :</strong></td>
			<td id='tim' colspan='4'></td>
		<tr>
...
<?php 
	...
	$str="res=$reserve_id&rom=$room_id&name=$name&lname=$lname";
?>
		<input type="button" class="inp" id="prt" value="چاپ" onClick="window.print()"  >
