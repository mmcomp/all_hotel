...
//////////////////////
	...
	$sodor.="<select name='name2' id='id2' class='cl form-control' tabindex='7'>";
	...
	$sour="";
	$tmp = statics_class::loadByKey('شهر');
	$sour.="<select name='name11' id='id11' class='cl form-control select2-01 col-md-12 full-width-fix' tabindex='13'>";
	...
	$de="";
	$tmp = statics_class::loadByKey('شهر');
	$de.="<select name='name14' id='id14' class='cl form-control' tabindex='14'>";
	...
	$rel="";
	$tmp = statics_class::loadByKey('نسبت');
	$rel.="<select name='name19' id='id19' class='cl form-control' tabindex='15'>";
										  ...
										  <div class="form-group col-md-12">
                                            ...
                                            <div class="form-group col-md-12">
                                              ...
                                              <div class="col-md-4">
											     ...
											     <div class="col-md-9"><input tabindex="6" id="datepicker1" type="text" name="name18" class="form-control" ></div>
                                              </div>
										  </div>
                                            <div class="form-group col-md-12">
                                              <div class="col-md-4">
                                            ...
                                            <div class="form-group col-md-12">
                                              <div class="col-md-4">
											     ...
											     <div class="col-md-9"><input tabindex="16" type="text" name="name23" class="form-control" ></div>
                                              </div>
                                              <div class="col-md-4">
											     <label class="col-md-3 control-label">ت ازدواج:</label> 
											     <div class="col-md-9"><input tabindex="17" id="datepicker3" type="text" name="name21" class="form-control" ></div>
                                              </div>
                                              <div class="col-md-4">
                ...
                foreach ($mehmans as $mehman){
                    ...
                    if(fmod($i,2)!=0){
                        echo "<tr class='odd'>
                                            ...
                                            <td>$mmtt</td>
                                            <td>$gen</td>
                                            <td><a onclick=\"editMehman('$mmid','$room_id','$mmfname','$mmlname','$mmp_n','$mmss','$mmtt','$mmgender')\" data-toggle='modal' title=\"ویرایش\"><i style=\"color:green;font-size:18px;cursor:pointer\" class=\"fa fa-edit\"></i></a></td>
                   ...
                   <div class="form-group col-md-12">
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="col-md-4">
						    ...
						    <div class="col-md-8"><input id="datepicker2" type="text" name="tt" class="form-control"></div>
                        </div>
                   </div>  
                </form>	
			 </div>
...
<div id="loading">
	...
	<script>
        ...
        function editFinal(){
            ...
            var gender1 = $("input[name='gender']").val();
            StopLoading();
            $.post("pazireshEditAjax.php",{omid1:mid1,oroom_id1:room_id1,ofname1:fname1,olname1:lname1,opname1:pname1,oss1:ss1,ott1:tt1,ogender1:gender1},function(data){
                StopLoading();
                if(data=="0"){
                    alert("اشکال در ثبت");
                }
    ...
    function StopLoading(){
        ...
        function editMehman(id,room_id,mmfname,mmlname,mmp_n,mmss,mmtt,mmgender){
            StartLoading();
