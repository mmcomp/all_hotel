        ...
        <table style="width:100%;margin-right:10px;" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align:right;">ارسال کننده</th>
                                            <th style="text-align:right;">نظر</th>
                                            <th style="text-align:right;">تاریخ</th>
                                        </tr>
                                    </thead>
                                    <tbody>';
mysql_class::ex_sql("select * from `in_sms` where `en`='0' ",$ss);
$i=1;
        ...
        $out1 .= "
        <tr class=\"odd\"><td>$i</td><td>$mobile</td><td>$message</td><td>$tarikh</td></tr>
        ";$i++;
    }
    else{
...
<head>
	...
	<meta charset="utf-8" />
	<title>گزارش پیامک های خوانده نشده</title>
                ...
                <div class="col-lg-12" style="padding:0px;">
                    <div class="panel panel-default" style="border: 1px solid #ffae2e;">
                        <div class="panel-heading" style="background-color:#ffae2e;color:white;padding:1px;">
                            <h4 style="margin-right:20px;"><i style="margin-left:10px;" class="fa fa-envelope"></i>گزارش پیامک های خوانده نشده</h4>
