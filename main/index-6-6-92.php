<?php
	...
	if($conf->sms)
	{
		...
		mysql_class::ex_sql("select `id`,`name` from `khadamat` where `name`='گشت'",$q);
	        while ($r = mysql_fetch_array($q))
        	{
			$kh_id = $r['id'];
			...
			while ($r_u = mysql_fetch_array($qu))
				...
				$reserve_id = $r_u["reserve_id"];
			        ...
			        $send_sms = sms_class::gasht_text_sms($reserve_id,$shomare);
			}
		}
	}
	if($firstVisit){
...
//var_dump($_SESSION);
	...
	$tmp2=array('main_param'=>array('dafater'=>null,'agency'=>null,'user_manage'=>null,'hozoor_ghiab'=>null,'m_hotel'=>null,'hotel_daftar'=>null,'watcher'=>null,'paziresh_info'=>null,'ticket'=>null,'enteghad_modir'=>null,'shenavar'=>null),'accu'=>array('h_kol'=>null,'h_moeen'=>null,'sanad_new'=>null,'sanad_daftar'=>null,'sanad_belit'=>null,'hesab_close'=>null,'taraz'=>null,'bank'=>null));
        ...
        $tmp2['reports'] = array('sanad_gozaresh'=>null,'gozareshmande'=>null,'tarikh_gozaresh'=>null,'gozaresh_eshghal'=>null,'gozaresh_sms'=>null,'gozaresh_ghaza'=>null);
        $tmp2['backup'] = array('back'=>null,'restor'=>null);
        $tmp2['onUser'] = array('listUser'=>null,'listInOut'=>null);
        $tmp2['paziresh_main'] = array('paziresh'=>null,'check_factors'=>null,'room_status'=>null,'room_prob'=>null,'vasael_jamande'=>null);
	if($conf->sms)
	{
