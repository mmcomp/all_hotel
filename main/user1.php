<?php
	...
	$grid->columnHeaders[8]="ساعت موظف ورود";
	$grid->columnHeaders[9]="ساعت موظف خروج";
	$grid->columnHeaders[10]="ساعت موظف ورود<br/>شیفت دو";
	$grid->columnHeaders[11]="ساعت موظف خروج<br/>شیفت دو";
