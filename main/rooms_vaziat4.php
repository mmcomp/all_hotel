...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div align="center">
			...
			<table >
				<tr>
					<td style="background-color:#b72b13;	-webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px; border:1px solid black;padding:5px;"><a target="_blank" href="mehman.php">تعداد میهمانان حاضر در هتل</a></td>
