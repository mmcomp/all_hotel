...
//////////////////////
	$jensiat = "";
	$tmp = statics_class::loadByKey('جنسیت');	
	$jensiat .= "<select name='name20' id='id20' class='cl' tabindex='6'>";
	...
	$meli="";
	$tmp = statics_class::loadByKey('ملیت');
	$meli.="<select name='name22' id='id22' class='cl' tabindex='7'>";
	...
	$sodor="";
	$tmp = statics_class::loadByKey('شهر');
	$sodor.="<select name='name2' id='id2' class='cl' tabindex='8'>";
	...
	$sour="";
	$tmp = statics_class::loadByKey('شهر');
	$sour.="<select name='name11' id='id11' class='cl' tabindex='11'>";
	...
	$de="";
	$tmp = statics_class::loadByKey('شهر');
	$de.="<select name='name14' id='id14' class='cl' tabindex='12'>";
	...
	$rel="";
	$tmp = statics_class::loadByKey('نسبت');
	$rel.="<select name='name19' id='id19' class='cl' tabindex='14'>";
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function vali()
		{
			...
			$(".cl").each(function(id,field){
				if(($(field).is('input') && $(field).val() == '')||($(field).is('select') && $(field).val() == '-1')||($(field).is('textarea') && $(field).val() == ''))
					out= false;
	...
	<table  class="general_div" align="center"  >
		...
		<td>نام تور :</td>
		<td><input value="ندارد" type="text" name="name3" id="id3" class="cl" size="15" tabindex="17"></td>
		</tr>
		

		<tr><td >نام:</td>
		<td><input type="text" name="name4" id="id4" class="cl" size="15" tabindex="1"></td>
		<td>شغل :</td>
		<td><input value="آزاد" type="text" name="name5" id="id5" class="cl" size="15" tabindex="9"></td>
		<td> پیش پرداخت :</td>
		<td><input value="0" type="text" name="name6" id="id6" class="cl" size="15" tabindex="18"></td>
		</tr>


		<tr><td>نام خانوادگی :</td>
		<td><input type="text" name="name7" id="id7" class="cl" size="15" tabindex="2"></td>
		<td>دلیل سفر :</td>
		<td><input value="زیارت" type="text" name="name8" id="id8" class="cl" size="15" tabindex="10"></td>
		<td>هزینه :</td>
		<td><input value="0" type="text" name="name9" id="id9" class="cl" size="15" tabindex="19"></td>
		</tr>
		...
		<td><?php echo $sour;?></td>
		<td>هزینه اضافی :</td>
		<td><input value="0" type="text" name="name12" id="id12" class="cl" size="15" tabindex="20"></td>
		</tr>

		<tr><td>نام پدر :</td>
		<td><input value="علی" type="text" name="name13" id="id13" class="cl" size="15" tabindex="3"></td>
		<td>مقصد :</td>
		<td><?php echo $de;?></td>
		<td>نفر اضافی :</td>
		<td><input value="0" type="text" name="name15" id="id15" class="cl" size="15" tabindex="21"></td>
		</tr>
		
		<tr><td>شماره شناسنامه :</td>
		<td><input value="111" type="text" name="name16" id="id16" class="cl" size="15" tabindex="4"></td>
		<td>کد ملی :</td>
		<td><input value="111"  type="text" name="name17" id="id17" class="cl" size="15"  tabindex='13'></td>
		
		</tr>
		
		<tr><td>تاریخ تولد :</td>
		<td><input type="text" name="name18" id="id18" class="cl" size="15" onblur="f1(this);" tabindex="5" ></td>
		<td>نسبت :</td>
		<td><?php echo $rel;?></td>
		</tr>
		...
		<td>تاریخ ازدواج :</td>
		<td><input type="text" name="name21" id="id21" class="cl" size="15" onblur="f1(this);" tabindex="15"></td>
		</tr>

		<tr><td>ملیت :</td>
		<td><?php echo $meli;?></td>
		<td>موبایل :</td>
		<td><input type="text" name="name23" id="id23" class="cl" size="15" tabindex="16"></td>
		</tr>
		<tr><td> توضیحات:</td><td>
		<textarea cols='20' rows='2' name="name26" id="id26" class="cl" tabindex="22">ندارد</textarea>
		</td></tr>
		...
		<tr><td colspan='6' align='center'><button onclick="vali();" tabindex='23'>ذخیره اطلاعات</td></tr>
