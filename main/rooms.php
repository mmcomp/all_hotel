            ...
            if(fmod($i,2)!=0){
                $rsout1.="
                    <tr class=\"odd\">
                                        ...
                                        <td>".loadPic($id)."</td>
                                        <td>
                                            <a onclick=\"editroomsfunc('".$id."','".$room_typ_id."','".$name."','".$tabaghe."','".$tozih."')\" data-toggle=\"modal\"><button style=\"margin:5px;min-width:90px;\" class=\"btn btn-info\"><i class=\"fa fa-pencil-square-o\"></i> ویرایش</button></a>
...
<div id="loading">
	...
	<script>
        ...
        function insertFinalrooms(){
            ...
            $.post("roomsAjax.php",{hid1:hid1,rtype1:rtype1,rname1:rname1,rtozih1:rtozih1,rtabaghe1:rtabaghe1},function(data){
               StopLoading();
               if(data=="0")
                   alert("خطا در افزودن");
               if(data=="1"){
        ...
        function editroomsfunc(id,room_typ_id,name,tabaghe,tozih){
            StartLoading();
        ...
        function editFinalrooms(){
           ...
           $.post("roomsEditAjax.php",{rrid1:rrid1,rname2:rname2,rtozih2:rtozih2,rtype2:rtype2,rtabaghe2:rtabaghe2},function(data){
               StopLoading();
