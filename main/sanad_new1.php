...
/**********************LISTS************************/
	...
	mysql_class::ex_sql("select sum(`mablagh`*`typ`) as jam from `sanad` where `en` = '0' and `shomare_sanad` ='$shomare_sanad'" ,$gg);
	mysql_class::ex_sql("select sum(`mablagh`) as jam from `sanad` where `en` = '0' and `typ`=1 and `shomare_sanad` ='$shomare_sanad'" ,$qbes);
		mysql_class::ex_sql("select sum(`mablagh`) as jam from `sanad` where `en` = '0' and `typ`=-1 and `shomare_sanad` ='$shomare_sanad'" ,$qbed);
...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<?php echo security_class::blockIfBlocked($se,lang_fa_class::block); ?>
			...
			<form id="frm1" method="POST"  > 
				...
				تاریخ : <input class="inp"  id="form_tarikh_sanad" name="form_tarikh_sanad" value="<?php echo $tarikh_sanad; ?>"/>
				...
				<input type="hidden" id="mod" name="mod" value="add" />
                        ...
                        <br/> 
                        <?php echo $out;  ?>
			<input type="button" value="ثبت نهایی" class="inp" onclick="send_frm();"  >
                </div>
