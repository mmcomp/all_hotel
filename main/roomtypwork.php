...
";
	mysql_class::ex_sql("select `room_typ_working_date`.`id`,`aztarikh`,`tatarikh`,`typ`,`ghimat`,`ghimat_ezafe`,`name`,`room_typ_id` from `room_typ_working_date` left join `room_typ` on (`room_typ_id`=`room_typ`.`id`) where  `hotel_id` = $hotel_id order by `aztarikh` desc",$ss);
	$i=1;
            ...
            if(fmod($i,2)!=0){
                $hwout1.="
                    <tr class=\"odd\">
                                        ...
                                        <td>$ghimat_ezafe</td>
                                        <td>
                                            <a onclick=\"edithotelworkfunc('".$hwid."','".$azta."','".$tata."','".$typ."','".$ghimat."','".$ghimat_ezafe."','".$room_typ_id."')\" data-toggle=\"modal\"><button style=\"margin:5px;min-width:90px;\" class=\"btn btn-info\"><i class=\"fa fa-pencil-square-o\"></i> ویرایش</button></a>
                ...
                <div class="col-lg-12" style="padding:0px;">
                    <div class="panel panel-default" style="border: 1px solid #ffae2e;">
                        <div class="panel-heading" style="background-color:#ffae2e;color:white;padding:1px;">
                            <h4 style="margin-right:20px;"><i style="margin-left:10px;" class="fa fa-money"></i>قیمت اتاق</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height:300px;overflow-y:scroll">
                    <form class="form-horizontal row-border" action="#">
                        ...
                        <div class="col-md-6">
                            <label>اتاق: </label>
                            <select class='form-control' id="room_typ_id1" name="room_typ_id1">
															<?php echo loadRoomTyps(0); ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label>سرویس اضافه: </label>
                            <input type="text" name="ghimat_ezafe1" value="" class="form-control" value ="0" />
                        </div>
                ...
                <div class="modal-body" style="max-height:300px;overflow-y:scroll">
                    <form class="form-horizontal row-border" action="#">
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label>اتاق: </label>
                            <select class='form-control' id="room_typ_id2" name="room_typ_id2">
															<?php echo loadRoomTyps(0); ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label>سرویس اضافه: </label>
                            <input type="text" name="ghimat_ezafe2" value="" class="form-control" />
                        </div>
...
<div id="loading">
	...
	<script>
        ...
        function insertFinalhw(){
            ...
            var ghimat_ezafe1 = $("input[name='ghimat_ezafe1']").val(); 
            var room_typ_id1 = $("#room_typ_id1 option:selected").val(); 
            $.post("roomtypworkAjax.php",{hid1:hid1,azta1:azta1,tata1:tata1,type1:type1,cost1:cost1,ghimat_ezafe1:ghimat_ezafe1,room_typ_id1:room_typ_id1},function(data){
               StopLoading();
               if(data=="0")
                   alert("خطا در افزودن");
               if(data=="1"){
        ...
        function edithotelworkfunc(hwid,aztarikh,tatarikh,typ,ghimat,ghimat_ezafe,room_typ_id){
            StartLoading();
            ...
            $("input[name='ghimat_ezafe2']").val(ghimat_ezafe);
            $("#room_typ_id2 option[value="+room_typ_id+"]").attr('selected','selected');
        ...
        function editFinalhotelwork(){
            ...
            var ghimat_ezafe2 = $("input[name='ghimat_ezafe2']").val();
            var room_typ_id2 = $("#room_typ_id2 option:selected" ).val();
//             alert(room_typ_id2);
						var p = {hwid2:hwid2,azta2:azta2,tata2:tata2,type2:type2,cost2:cost2,ghimat_ezafe2:ghimat_ezafe2,room_typ_id2:room_typ_id2};
// 						console.log(p);
					
            $.post("roomtypworkEditAjax.php",p,function(data){
                StopLoading();
// 								console.log(data);
        ...
        function deleteFinalhotelwork(){
            ...
            $.post("roomtypworkDeleteAjax.php",{hwid3:hwid3},function(data){
                StopLoading();
                if(data=="0")
                    alert("خطا در حذف");
                if(data=="1"){
