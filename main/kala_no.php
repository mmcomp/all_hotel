...
session_start();
	...
	if(!isset($_SESSION['user_id']))
        ...
        if(!$se->can_view || !$conf->anbar)
                die(lang_fa_class::access_deny);
	$grid = new jshowGrid_new("kala_no","grid1");
	$grid->whereClause="1 = 1 order by `name`";
	$grid->columnHeaders[0] = null;
        $grid->columnHeaders[1] = "نوع کالا";
...
$out='<div class="box border orange">
									...
									<div class="box-body" style="overflow-x:scroll">
										<table class="table table-hover">
											...
											<tbody>';
mysql_class::ex_sql("select * from `kala_no` where 1 = 1 order by `name`",$ss);
    $i=1;
    ...
    <tr>
        <td>".$i."</td>
         <td>".$name."</td>
         <td>".$code."</td>
         <td><a onclick=\"editGfunc('".$id."','".$name."','".$code."')\" data-toggle=\"modal\"><button style=\"margin:5px;min-width:90px;\" class=\"btn btn-info\"><i class=\"fa fa-pencil-square-o\"></i> ویرایش</button></a>
                ...
                <div class="col-lg-12" style="padding:0px;">
                    <div class="panel panel-default" style="border: 1px solid #ffae2e;">
                        <div class="panel-heading" style="background-color:#ffae2e;color:white;padding:1px;">
                            <h4 style="margin-right:20px;"><i style="margin-left:10px;" class="fa fa-shopping-cart"></i>نوع کالا</h4>
                                
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body" id="panel-body">
                               
                            <a href="#newG"  data-toggle="modal"><button class="btn btn-success btn-lg"><i class="fa fa-plus"></i>افزودن نوع کالا جدید</button></a>
                            <br/>
                           <?php	echo $out;?>
                    ...
                    <form class="form-horizontal row-border" action="#">
                        <div class="col-md-6">
                            <label>نوع کالا: </label>
                             <input class="form-control" type="text" value="" name="kala1" />
                        </div>
                        <div class="col-md-6">
                            <label>کد کالا: </label>
...
<div id="loading">
	...
	<script>
        ...
        function insertFinalG(){
            StartLoading();
            var kala1 = $("input[name='kala1']").val();
            var code1 = $("input[name='code1']").val();
           $.post("kala_noAjax.php",{kala1:kala1,code1:code1},function(data){
                                    StopLoading();
                                    if(data=="0")
                                        alert("خطا در افزودن");
                                    if(data=="1"){
        ...
        function editGfunc(id,name,code){
            StartLoading();
        ...
        function editFinalG(){
            ...
            $.post("kala_noEditAjax.php",{id2:id2,name2:name2,code2:code2},function(data){
                                    StopLoading();
                                    if(data=="0")
                                        alert("خطا در ویرایش");
                                    if(data=="1"){
        ...
        function deleteFinalG(){
           ...
           $.post("kala_noDeleteAjax.php",{id3:id3},function(data){
               StopLoading();
               if(data=="0")
                   alert("خطا در حذف");
               if(data=="1"){
