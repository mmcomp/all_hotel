<?php
	...
	if(isset($_REQUEST['room_id']))
	{
		...
		$khorooj = '';
		$is_khorooj = reserve_class::isKhorooj($reserve_id);
		...
		if(!$is_khorooj && reserve_class::isPaziresh($reserve_id))
			$khorooj = "<a style='color:green;' target='_blank' href='report.php?req=$reserve_id&room_id=$room_id&' >حساب</a> <a style='color:red' target='_blank' href='paziresh.php?reserve_id=$reserve_id_code&kh=1' >خروج</a>";
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div align="center">
				...
				<textarea class="inp" name="tozih" id="tozih" " rows="2" cols="50" ></textarea>
				</span>
				اتاق:
				...
				<input type='button' value='اعمال' class="inp" onclick="sabt();">
				<div id="khoon" ></div>
				<?php
