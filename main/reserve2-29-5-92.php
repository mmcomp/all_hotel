<?php
	...
	if(isset($_REQUEST['mod1']) && $_REQUEST['mod1']==5 )
	{
		...
		if($is_reserve)
		{
			...
			if($tmp1)
				$tmp1 = room_det_class::preReserve($hotel_id,$ajans_id,$tmp_room,$hotel_ghimat,$aztarikh,$shab,$tedad_otagh,$shab_reserve,$rooz_reserve,$tedad_nafarat,$khadamat_arr,$ta_gasht);
			else
