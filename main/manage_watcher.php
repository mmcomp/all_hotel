<?php
    ...
    <div class="box border orange">
									<div class="box-title">
										<h4><i class="fa fa-bar-chart-o"></i>راهنما</h4>
	...
	$matn = $conf->watcher;
	$box = "<textarea class=\"form-control\"  style=\"overflow-y: scroll;overflow-x: scroll;\" name=\"content\" id=\"content\"  >$matn</textarea>";
                ...
                <div class="col-lg-12" style="padding:0px;">
                    <div class="panel panel-default" style="border: 1px solid #ffae2e;">
                        <div class="panel-heading" style="background-color:#ffae2e;color:white;padding:1px;">
                            <h4 style="margin-right:20px;"><i style="margin-left:10px;" class="fa fa-text-height"></i>مدیریت واچر</h4>
                                
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body" id="panel-body">
                          <form id='frm1' method="POST" style="overflow-x:scroll" >
			<?php 
				echo $box.'<br />';
				echo $ckscript;
				
			?>
                              <button style="margin: 5px;" class="btn btn-success col-md-3" onclick="save_frm();">ذخیره سازی</button>
                              <button style="margin: 5px;" class="btn btn-danger col-md-3" onclick="cancel_frm();">انصراف</button>
