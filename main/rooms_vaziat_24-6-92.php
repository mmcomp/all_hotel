...
//echo "select `id`,`name` from room_typ where `id`='$typ_room'order by zarfiat";
	...
	$combo .= "</form>";
	$out = hotel_class::getRack_new($hotel_id,$room_typ,$se);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<!-- Style Includes -->
		<meta http-equiv="refresh" content="100;url=rooms_vaziat.php">
		...
		<div align="center">
			...
			<table>
				...
				<?php
					...
					echo '<td style="background-color:#b5d3ff;	-webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px; border:1px solid black;padding:5px;"><a target="_blank" href="otagh_vorodi.php">ورودی های امروز</a></td>';		
				?>
				</tr>
				<tr>
