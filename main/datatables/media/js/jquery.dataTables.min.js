...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"اولين",sLast:"آخرين",sNext:"بعدي",sPrevious:"قبلي"},sEmptyTable:"هيچ داده اي موجود نيست",sInfo:"نمايش _START_ از _END_ از مجموع _TOTAL_ رديف",sInfoEmpty:"نمايش 0 رديف ",sInfoFiltered:"(انتخاب از مجموع _MAX_ رديف)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"نمايش _MENU_ رديف",sLoadingRecords:"در حال بارگزاري...",sProcessing:"در حال پردازش...",sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"هيچ رديفي يافت نشد..."},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
