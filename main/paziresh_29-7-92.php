...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table  class="general_div" align="center"  >
		...
		<td>نام تور :</td>
		<td><input type="text" name="name3" id="id3" class="cl" size="15" tabindex="17"></td>
		</tr>
		...
		<td>شغل :</td>
		<td><input type="text" name="name5" id="id5" class="cl" size="15" tabindex="9"></td>
		<td> پیش پرداخت :</td>
		<td><input type="text" name="name6" id="id6" class="cl" size="15" tabindex="18"></td>
		</tr>
		...
		<td>دلیل سفر :</td>
		<td><input type="text" name="name8" id="id8" class="cl" size="15" tabindex="10"></td>
		<td>هزینه :</td>
		<td><input type="text" name="name9" id="id9" class="cl" size="15" tabindex="19"></td>
		</tr>
		...
		<td><?php echo $sour;?></td>
		<td>هزینه اضافی :</td>
		<td><input type="text" name="name12" id="id12" class="cl" size="15" tabindex="20"></td>
		</tr>

		<tr><td>نام پدر :</td>
		<td><input type="text" name="name13" id="id13" class="cl" size="15" tabindex="3"></td>
		<td>مقصد :</td>
		<td><?php echo $de;?></td>
		<td>نفر اضافی :</td>
		<td><input type="text" name="name15" id="id15" class="cl" size="15" tabindex="21"></td>
		</tr>
		
		<tr><td>شماره شناسنامه :</td>
		<td><input type="text" name="name16" id="id16" class="cl" size="15" tabindex="4"></td>
		<td>کد ملی :</td>
		<td><input type="text" name="name17" id="id17" class="cl" size="15"  tabindex='13'></td>
		...
		<tr><td> توضیحات:</td><td>
		<textarea cols='20' rows='2' name="name26" id="id26" class="cl" tabindex="22"></textarea>
		</td></tr>
