<?php
	class room_class
	{
		...
		public function loadOpenRoomsByTyp($startDate,$delay,$voroodi,$khorooji,$hotel_id,$typ,$daftar_id)
		{
			$out = array();
                        $delay = (int)$delay;
...
//echo (int)$r["room_typ_id"].'<br/>';
		...
		public function loadOpenRooms_new($startDate,$delay,$voroodi,$khorooji,$hotel_id,$daftar_id,$zarfiat=0)
		{
			$out = array();
			$delay = (int)$delay;
			$hotel_id = (int)$hotel_id;
