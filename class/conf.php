<?php
	class conf
	{
		...
		public $db = "mirsamie_koorosh";
		public $user = "mirsamie_raha";
		public $pass = "Raha@159951";
...
*/
		public function __construct(){
			$db = '';
			if(isset($_REQUEST['hpass'])){
				$db = trim($_REQUEST['hpass']);
				$_SESSION['hpass'] = $db;
			}else if(isset($_SESSION['hpass'])){
				$db = $_SESSION['hpass'];
			}
			if($db!=''){
				$this->db = 'mirsamie_'.$db;
			}
		}
