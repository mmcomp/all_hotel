...
function createResult($rooms,$adult,$child,$aztarikh,$paztarikh,$shab,$ghimat){
	...
	$out = '<form method="post" id="frm1"><div class="panel1" style="margin-top:30px;">';
...
// 			echo "loading<br/>";
	...
	$out.='<div class="col-md-6 col-sm-12" style="background:rgba(220, 216, 213, 0.23);height:'.$height.';text-align:right;direction:rtl;color:#fff;font-size:bold;">';
	$class="row col-md-12";
...
/////////////////////////////////////////////////////
$out= str_replace("#aztarik#",(trim($aztarikh)=="")?"۱۳۹۵/۱۰/۳۰":$aztarikh,$out);
/////////////////////////////////////////////////////
